...
abstract class $DestinationApiCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? name, String? placeId, Geometry? geometry});
...
class _$DestinationApiResponse extends DestinationApiResponse {
  const _$DestinationApiResponse(
      {required this.name, required this.placeId, required this.geometry})
      : super._();
  ...
  @override
  String toString() {
    return 'DestinationApi.response(name: $name, placeId: $placeId, geometry: $geometry)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return response(name, placeId, geometry);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return response?.call(name, placeId, geometry);
  }
...
abstract class DestinationApiResponse extends DestinationApi {
  const factory DestinationApiResponse(
      ...
      required final Geometry? geometry}) = _$DestinationApiResponse;
